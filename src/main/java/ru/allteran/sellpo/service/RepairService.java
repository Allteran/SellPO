...
public class RepairService {
    ...
    public void createRepairRequest(RepairRequest request, Map<String, String> form) {
        ...
        for (String posId : form.values()) {
            PointOfSales pos = posRepo.findFirstById(Integer.parseInt(posId));
            if (pos != null) {
                request.setPosId(pos.getId());
                break;
            }
        }
        //TODO END method with saving request
